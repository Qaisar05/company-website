            ...
            <div class="d-flex align-items-stretch flex-shrink-0">
              <div class="d-flex align-items-stretch ms-1 ms-lg-3">
                      ...
                      <div data-kt-search-element="wrapper">
                          ...
                          <div class="scroll-y mh-200px mh-lg-350px">
                            ...
                            >
                              <div class="symbol symbol-40px me-4">
                                <img
                                  src="dist/assets/media/avatars/150-1.jpg"
                                  alt=""
                                />
                              </div>
                            ...
                            >
                              <div class="symbol symbol-40px me-4">
                                <img
                                  src="dist/assets/media/avatars/150-3.jpg"
                                  alt=""
                                />
                              </div>
                              <div class="d-flex flex-column justify-content-start fw-bold">
                            ...
                            >
                              <div class="symbol symbol-40px me-4">
                                <img
                                  src="dist/assets/media/avatars/150-8.jpg"
                                  alt=""
                                />
                              </div>
                              <div class="d-flex flex-column justify-content-start fw-bold">
                            ...
                            >
                              <div class="symbol symbol-40px me-4">
                                <img
                                  src="dist/assets/media/avatars/150-11.jpg"
                                  alt=""
                                />
                              </div>
                              <div class="d-flex flex-column justify-content-start fw-bold">
                            ...
                            >
                              <div class="symbol symbol-40px me-4">
                                <img
                                  src="dist/assets/media/avatars/150-12.jpg"
                                  alt=""
                                />
                              </div>
                              <div class="d-flex flex-column justify-content-start fw-bold">
                            ...
                            >
                              <div class="symbol symbol-40px me-4">
                                <span class="symbol-label bg-light">
                                  <img
                                    class="w-20px h-20px"
                                    src="dist/assets/media/svg/brand-logos/leaf.svg"
                                    alt=""
                                  />
                                </span>
                              </div>
                            ...
                            >
                              <div class="symbol symbol-40px me-4">
                                <span class="symbol-label bg-light">
                                  <img
                                    class="w-20px h-20px"
                                    src="dist/assets/media/svg/brand-logos/tower.svg"
                                    alt=""
                                  />
                                </span>
                              </div>
                        ...
                        <div class="mb-4" data-kt-search-element="main">
                          ...
                          <div class="scroll-y mh-200px mh-lg-325px">
                            ...
                            <div class="d-flex align-items-center mb-5">
                              <div class="symbol symbol-40px me-4">
                                <span class="symbol-label bg-light"></span>
                              </div>
                              <div class="d-flex flex-column">
                                <a
                                  href="#"
                        ...
                        <div class="d-flex flex-column px-9">
                          ...
                          <div class="text-center px-4">
                            <img
                              ...
                              alt="image"
                              src="dist/assets/media/illustrations/sketchy-1/1.png"
                            />
                          </div>
                        </div>
                      </div>
                ...
                >
                  ...
                  >
                    <img
                      src="dist/assets/media/avatars/150-26.jpg"
                      alt="user"
                    />
                  </div>
                  <div
